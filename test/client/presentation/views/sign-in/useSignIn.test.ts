...
import { useSignIn } from '@/src/client/presentation/views/sign-in/hook/useSignIn';
import { useAuthStore, configureAuthStore } from '@/src/client/presentation/stores/authStore';
