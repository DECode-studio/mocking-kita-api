...
describe('EnvironmentUseCaseImpl', () => {
  ...
  const activeEnv: Environment = {
    ...
    variables: [{ id: 'var-1', key: 'baseUrl', value: 'http://localhost:3000', type: 'plain', enabled: true }],
  ...
  const deletedEnv: Environment = {
    ...
    variables: [{ id: 'var-2', key: 'baseUrl', value: 'http://localhost:3001', type: 'plain', enabled: true }],
