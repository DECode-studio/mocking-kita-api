...
import { useRequestScenarioEditor } from '@/src/presentation/views/request-scenario-editor/hook/useRequestScenarioEditor';
...
vi.mock('@/src/presentation/stores/uiStore', () => ({
  useUIStore: () => ({
