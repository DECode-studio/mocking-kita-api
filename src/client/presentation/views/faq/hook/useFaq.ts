...
import { FaqUseCase } from '@/src/client/domain/faq/usecase/faq_usecase';
import { getService, CLIENT_DI_TOKENS } from '@/src/core/di';

export function useFaq(customFaqUseCase?: FaqUseCase, initialFaqs: Faq[] = []) {
  const faqUseCase = customFaqUseCase || getService(CLIENT_DI_TOKENS.faqUseCase);
