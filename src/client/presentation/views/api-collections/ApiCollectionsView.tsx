...
interface ApiCollectionsViewProps {
  ...
  initialApis?: import('@/src/client/domain/api/entity/api_collection').ApiCollection[];
...
export const ApiCollectionsView: React.FC<ApiCollectionsViewProps> = ({
  ...
  const {
    ...
    ungroupedApis,
    hasNoItems,
  } = useApiCollections(undefined, undefined, embeddedProjectId, initialApis, initialCollections);
