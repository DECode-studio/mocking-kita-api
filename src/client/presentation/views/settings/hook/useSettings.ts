...
import { DatabaseResetUseCase } from '@/src/client/domain/database/usecase/database_reset_usecase';
...
export function useSettings(customDatabaseResetUseCase?: DatabaseResetUseCase) {
  const databaseResetUseCase = customDatabaseResetUseCase || getService(CLIENT_DI_TOKENS.resetDatabaseUseCase);
