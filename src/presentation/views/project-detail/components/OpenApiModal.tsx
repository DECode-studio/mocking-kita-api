      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-2xl space-y-4">
          ...
          <p className="text-xs text-slate-500">
            Export or Import OpenAPI 3.0 / Swagger JSON specifications specifically for <span className="font-semibold text-slate-700 dark:text-slate-300">{projectName}</span>.
          </p>
          ...
          {activeTab === 'export' ? (
            <div className="space-y-4 py-2">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-300 space-y-1">
                <div className="font-semibold">Export Format: OpenAPI 3.0.3 (JSON)</div>
            ...
            <div className="space-y-3 py-1">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  Upload File or Paste OpenAPI JSON
                </label>
                <input
                  type="file"
                ...
                <textarea
                  ...
                  placeholder="Paste OpenAPI / Swagger JSON spec here..."
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                >
                  ...
                  {loading ? 'Importing...' : 'Import OpenAPI'}
                </button>
              </div>
            </div>
          )}
